...
@section('pageDesc','Manage orders, payments, coupons and taxes.')
  ...
  <div class="mt-4 overflow-x-auto">
    <table class="w-full text-sm">
      ...
      <tbody>
        @forelse($orders as $o)
          <tr class="border-t border-slate-100 dark:border-slate-800">
            ...
            <td class="py-3 pr-3">
              ...
              <div class="text-xs text-slate-500 dark:text-slate-400">{{ $o->customer?->email ?? '—' }}</div>
            </td>
        ...
        @empty
          <tr><td colspan="6" class="py-10 text-center text-slate-500 dark:text-slate-400">No orders found.</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
