   ...
   private function validateOrder(Request $request): array
{
    return $request->validate([
        ...
        // ✅ FIX: product_id is OPTIONAL (supports old/manual items)
        'items.*.product_id'    => ['nullable', 'integer', 'exists:products,id'],

        // ✅ Ensure we still have a product name even if no product_id
        ...
        // ✅ TXN required only for online methods
        ...
        // ✅ No more “product required” message
        'items.required'                 => 'At least one item is required.',
        'items.*.product_name.required'  => 'Product name is required for each item.',
        'items.*.qty.required'           => 'Qty is required for each item.',
