...
class OrderController extends Controller
{
    ...
    private function buildItemsSafe(array $items): array
    {
        ...
        foreach ($items as $it) {
            ...
            // If selected product exists: use db name/sku
            // Else: use manual name/sku
            ...
            // ✅ include variant_id ONLY if column exists and sent by client
            if (Schema::hasColumn('order_items', 'variant_id')) {
                $row['variant_id'] = !empty($it['variant_id']) ? (int)$it['variant_id'] : null;
            }
