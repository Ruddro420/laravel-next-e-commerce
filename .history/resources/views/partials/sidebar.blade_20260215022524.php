...
<div class="space-y-1">
 ...
 <div
  class="pl-3 pr-1 overflow-hidden transition-[max-height] duration-300 ease-in-out"
  data-collapse-panel="products"
  data-collapse-default="{{ $openProducts ? 'open' : 'closed' }}"
  style="max-height: @if($openProducts) 500px @else 0px @endif"
>
    <a href="{{ route('products.index') }}" class="{{ $baseChild }} {{ $is('products.index') ? $activeChild : $idleChild }}">All Products</a>
