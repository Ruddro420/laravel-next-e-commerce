  ...
  <div class="mt-5 overflow-x-auto">
    <table class="w-full text-sm">
      ...
      <tbody>
        @forelse($roles as $r)
          @php
            $permIds = $r->permissions->pluck('id')->values();
          @endphp
...
(function(){
  ...
  function openModal(m){ m.classList.remove('hidden'); document.body.classList.add('overflow-hidden'); }
  function closeAll(){ modalCreate.classList.add('hidden'); modalEdit.classList.add('hidden'); document.body.classList.remove('overflow-hidden'); }
