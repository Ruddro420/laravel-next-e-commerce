...
Route::prefix('pos')->group(function () {
    ...
    // barcode
    Route::get('/barcode-labels', [\App\Http\Controllers\POSController::class, 'barcodeLabels'])
        ->name('pos.barcode.labels');

    Route::get('/barcode-products', [\App\Http\Controllers\POSController::class, 'barcodeProducts'])
        ->name('pos.barcode.products');

    Route::post('/barcode-labels/print', [\App\Http\Controllers\POSController::class, 'barcodeLabelsPrint'])
