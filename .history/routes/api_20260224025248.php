...
// Get Settings
Route::get('/settings/general', [GeneralSettingController::class, 'apiGetGeneralSettings']);
// Review API
Route::get('products/{id}/reviews', [ReviewApiController::class, 'productReviews']);
Route::post('products/{id}/reviews', [ReviewApiController::class, 'storeForProduct']);
